...
module.exports.run = async function({ api, event, args, prefix, admin }) {
		...
		const CREATORLINK = "https://www.facebook.com/ichiro.2025";
		const BOTCREATOR = "kysler";
		const BOTNAME = "Autobot by KYSLER ";
		const FILESOWNER = "kys";
...
⁂ Bot Name: autobot by kysler 
✧ Bot Admin: kysler 
♛ Bot Admin Link: https://www.facebook.com/ichiro.2025
❂ Bot Prefix: ${prefix}
